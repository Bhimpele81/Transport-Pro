...
/* tabs */
.tab-bar{display:flex;background:#fff;border-bottom:2px solid var(--border);position:sticky;top:68px;z-index:100}
...
<header>
  <img src="/static/logo.png" alt="Elbow Lane Day Camp" class="h-logo">
  <div>
