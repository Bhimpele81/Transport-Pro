...
def api_debug_coords():
    """Show all cached coordinates — helps diagnose missing map stops without API calls."""
    import json, os
...
function initVehicleMap(mapId, vehicle) {
  ...
  console.log(`Vehicle ${vehicle.name}: ${allPoints.length} stops with valid coords out of ${vehicle.stops.length} total`);
  // Camp destination
